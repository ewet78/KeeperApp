...
function App() {
    ...
    useEffect(() => {
        const fetchData = async () => {
          ...
          const userDataResponse = await fetch("https://keeperapp-server-7d63b47c3f57.herokuapp.com/app", {
            method: "POST",
            headers: {
          ...
          if (userDataResponse.ok) {
            ...
            const notesData = await Promise.all(
              userData.data.notes.map(async (noteId) => {
                const noteResponse = await fetch(`https://keeperapp-server-7d63b47c3f57.herokuapp.com/notes/${noteId}`, {
                  method: "GET",
                  headers: {
                    "Content-Type": "application/json",
                    "Accept": "application/json",
